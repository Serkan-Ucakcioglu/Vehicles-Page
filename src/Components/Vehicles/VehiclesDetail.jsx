  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col items-center cursor-pointer my-4 p-6 max-w-sm bg-slate-800 rounded border shadow-xl hover:bg-white hover:border hover:border-black dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
          <span className="text-cyan-600 text-sm font-bold uppercase pb-4">
            Brand: {vehicles?.brand}
          </span>
          <span className="text-emerald-600 text-sm font-bold uppercase pb-4">
